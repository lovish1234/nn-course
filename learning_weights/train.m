...
% given the batch size this function changes data to train, validation and test data
[train_input, train_target, valid_input, valid_target, ...
  test_input, test_target, vocab] = load_data(batchsize);
% here numwords is 3 , batchsize is 100, numbatches is 3275
...
% vocab_size is 250 , numhid varies
word_embedding_weights = init_wt * randn(vocab_size, numhid1);

% numwords is 3 , numhid and numhid2 varies 
...
% confirm the use of this matrix 
...
% embed_to_hid_weights = init_wt * randn(numwords * numhid1, numhid2); 150*200 , 200*100
